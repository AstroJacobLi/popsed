...
# 22.09.14
# lr3e-4, bins=50, n_trans=20, hid_feat=100, max_epochs=30, anneal_coeff=20, anneal_tau=7.5 is the best
# python deploy_nde_gama.py --output_dir='./NDE/GAMA/anneal/real/lr2e-4_ann7p5_30/' --seed_low=0 --seed_high=5 --num_bins=50 --num_transforms=20 --hidden_features=100 --max_lr=2e-4 --anneal_tau=7.5 --anneal_coeff=20 --max_epochs=30
