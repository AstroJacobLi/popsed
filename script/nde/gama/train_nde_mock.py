...
# Load NSA data
X_data = np.load('./NDE/GAMA/NMF/mock_mags_no_noise.npy')[:, :5]
# mags_gama = np.load(
...
# python train_nde_mock.py --seed_low=0 --seed_high=1 --n_samples=10000 --num_transforms=20 --num_bins=50 --hidden_features=128 --output_dir=./NDE/NMF/nde_theta_NMF_CDF_mock_flatdirich/ --add_noise=False --smallblur=True
